        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <motion.div
              {...fadeInUp}
            >
              <Card className="bg-gray-900/50 border-gray-700 rounded-2xl h-full">
                <CardHeader>
                  <CardTitle className="text-2xl sm:text-3xl font-bold text-white">Get in Touch</CardTitle>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">support@thearenax.com</p>
                      </div>
                    </div>
